...
<section aria-labelledby="product-heading" class="mt-6 lg:mt-0 lg:col-span-2 xl:col-span-3">
    <div class="pb-4">
        <h2 class="text-xl mt-5 tracking-tight">
            <a href="{{route('export-order/{id}', $orders->id)}}">Скачать накладную (EXCEL)</a>
        </h2>

        <h2 class="text-xl mt-2 tracking-tight">
            <a href="{{route('platform.order.check', $orders->id)}}">Просмотр накладной</a>
        </h2>
    </div>
