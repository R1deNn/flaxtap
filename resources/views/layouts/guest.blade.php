...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <nav style="background-color: #f3f3f3">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="{{route('/home')}}" class="">
                <img src="{{asset('images/logos/FlaxTapLogo.svg')}}" class="mr-3 h-9 sm:h-12" alt="FlaxTap logo" />
                <div class="text-sm mt-2">
                    <p>ПН-ПТ: 11:00 - 19:00</p>
                    <p>СБ-ВС : Выходной</p>
                    <p>Самовывоз</p>
                    <p>ВТ и ЧТ 12:00 - 18:30</p>
                </div>
            </a>
            <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                @auth
                        <div class="ml-6 mr-6">
                            <a href="{{route('/cart')}}" class="hidden md:block block text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0">
                        ...
                        <div class="ml-6 mr-6">
                            <a href="{{route('/your-likes')}}" class="hidden md:block block text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0">
                                <svg width="28px" height="28px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        @if(Auth::user()->roles->contains('id', 1))
                            <div class="ml-8 mr-8">
                                <a href="{{route('platform.main')}}" class="ml-4 mr-4 hidden md:block block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0">
                                    <svg width="28px" height="28px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        @else
                            <div class="ml-8 mr-8">
                                <a href="{{route('dashboard')}}" class="ml-4 mr-4 hidden md:block block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0">
                                    <svg width="28px" height="28px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M3 20C5.33579 17.5226 8.50702 16 12 16C15.493 16 18.6642 17.5226 21 20M16.5 7.5C16.5 9.98528 14.4853 12 12 12C9.51472 12 7.5 9.98528 7.5 7.5C7.5 5.01472 9.51472 3 12 3C14.4853 3 16.5 5.01472 16.5 7.5Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </a>
                        ...
                        @endif
                @else
                    <a href="{{ route('login') }}" type="button" class="text-center hidden md:block">Войти</a>
                @endauth
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
                <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
                    <li>
                        <a href="{{route('/home')}}" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0">Главная</a>
                    </li>
                    <li>
                        <a href="{{route('/shop')}}" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0">Каталог</a>
                    </li>
                    <li>
                        <a href="{{route('/deliver-and-payment')}}" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0">Доставка и оплата</a>
                    </li>
                    <li>
                        <a href="https://flaxtap.ru/" target="_blank" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0">Обучение</a>
                    </li>
                    <li class="mt-6"></li>
                    @auth
                        <a href="{{ route('/cart') }}" type="button" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 md:hidden">Корзина</a>
                        <a href="{{ route('/your-likes') }}" type="button" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 md:hidden">Избранное</a>
                            @if(Auth::user()->roles->contains('id', 1))
                            <a href="{{ route('platform.main') }}" type="button" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 md:hidden">Админ-панель</a>
                        @else
                            <a href="{{ route('dashboard') }}" type="button" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 md:hidden">Личный кабинет</a>
                            @endif
                        @else
                        <a href="{{ route('login') }}" type="button" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 md:hidden">Войти</a>
                    @endauth
                </ul>
            </div>
        </div>
    ...
    <footer style="background-color: #f3f3f3">
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase">Мы в социальных сетях</h2>
                    <ul class="flex text-gray-500 font-medium">
                        <li class="mb-4">
                        ...
                        <li class="ml-2" style="margin-top: 3px">
                            <a target="_blank" href="https://wa.me/79213367700" class="hover:underline">
                ...
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase">Связаться с нами</h2>
